...
//Its proper divisors are 1, 2, and 3 (since 6 is the value of
// the perfect number, it is excluded), and the sum of its proper
// divisors is 1 + 2 + 3 = 6.
//
...
// since its proper divisors are 1, 2, 3 and the sum is 1 + 2 + 3 = 6
//
//* isPerfectNumber(28); should return true
// since its proper divisors are 1, 2, 4, 7, 14
// and the sum is 1 + 2 + 4 + 7 + 14 = 28
//
//* isPerfectNumber(5); should return false
// since its only proper divisor is 1 and the sum is 1 not 5
//
...
//
//NOTE: The method isPerfectNumber should be defined
